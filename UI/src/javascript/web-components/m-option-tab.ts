...
export default class MOptionTab extends Component implements Observer {
    ...
    private init(): void {
        ...
        // this.setBalanceWidth(); We will use onesize to set with and balance to set orientation
    }
