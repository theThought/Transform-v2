...
export const loaders = [
    async () => {
        try {
            ...
            const xmlResponse = await fetch('https://thethought.github.io/Transform-v2/Dimensions/singleline_v2.xml');
            const xslResponse = await fetch('https://thethought.github.io/Transform-v2/Dimensions/question.xsl');
