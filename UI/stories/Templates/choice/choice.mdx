...
## complex combination of options
Options can appear inside sublists and outside of them, a single question can utilise multiple sublists.
<Canvas of={ChoiceStories.TComplexlist} />
<Controls of={ChoiceStories.TComplexlist} />