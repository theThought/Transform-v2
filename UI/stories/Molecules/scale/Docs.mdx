...
<Canvas of={ScaleContainerStories.TenContainer} />
<Controls of={ScaleContainerStories.TenContainer} />

## Seven point scale 
In this example the minimum is 1 and the maximum is 7.  The width defines how long the scale is.
<Canvas of={ScaleContainerStories.SevenContainer} />
<Controls of={ScaleContainerStories.SevenContainer} />
