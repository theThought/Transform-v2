export function OOptionBase_Story(args: any): HTMLElement {
    const container: HTMLElement = document.createElement('o-option-base');
    const containerClass: string = 'o-option-' + args.optionType;
